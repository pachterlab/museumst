...
```{r}
plot_ec(k_result2, seq(20, 60, by = 10))
```
...
```{r}
labelTopics(stm_res, c(23, 25, 28, 10, 20))
```
...
1. Diabetes
2. Biomechanics and morphogenesis
3. Cancer progression
4. Plant roots
5. Connective tissues and ECM
6. Eye lens
7. Neurological disorders, especially Alzheimer's
8. Prostate cancer, though more generally gene regulation in cancer
9. Blood and lymphatic vessels
10. Cancer associated stroma
11. Cancer signaling proteins
12. Bone growth plate
13. Plant reproduction
14. Development, especially when there're epitielial cells
15. Neuroscience
16. Not a good topic. Liver diseases, especially HCC, but also endometriosis
17. Pancreas and lacrimal gland
18. Lung development and diseases
19. Plant organ development and shedding
20. A bad one, so I'm not sure. Some entries are about dendritic spines but there're lots of other stuff as well.
21. Neural circuits, though there's some other stuff
22. Cancer genome abnormalities and epigenomics
23. Multi-omics, especially in cancer
24. Parasites, hybrids (especially plants), and symbiosis
25. Combination of scRNA-seq with spatial technologies
26. Ecology and evolution, especially plants
27. Mutations and rearrangements in genes expressed by cancer cells
28. Quantitative analyses of cancer molecular biology
29. Transcript amplification
30. Neuroscience, especially memory and behavior
31. Not a very good one. Fertility, aging, mitochondria
32. Gene sets from DE
33. Nitrogen fixation in plants
34. The ear, and somehow, circadian rhythm
35. ALS and spinal muscular atrophy, neurodegenerative diseases affecting motor neurons
36. miRNAs, especially in cancer
37. Hypothalamus and appetite
38. DLPFC, especially when it comes to schizophrenia
39. Skin diseases
40. Inflammatory diseases, especially atherosclerosis
41. Clinical oncology
42. Myocardium, especially myocardial infarction
43. Genetic screens. Someone DNA methylation also showed up though genetics is more dominant.
44. Tumor heterogeneity and microenvironment, especially in PDAC
45. Technical issues in isolation of tissue with LCM
46. Development, and somehow, smooth muscle, probably because some entries are about development of muscles
47. Quantitative analyses, especially in the hippocampus
48. Retina, though there's some other stuff as well
49. Cancer proteomics
50. iPSC

```{r}
topic_types <- tribble(~ category, ~ topic,
                       "Cancer", c(3,8,10,11,22,23,27,28,36,41,44,49),
                       "Botany", c(4,13,19,24,26,33),
                       "Neuroscience", c(7,15,21,30,35,37,38,47),
                       "Development", c(2,12,14,18,46),
                       "Technical", c(25,29,45))
```
...
```{r}
year_means %>% 
  filter(topic %in% as.character(c(3, 7, 14, 23, 38, 49))) %>% 
...
Here apparently the decline of the proportion of topic 3 and 14 may be in part due to growth of other topics. Growth of 23 and 38 seem more drastic when considering the counts, maybe also because other topics are growing.
...
ac_umap$cluster <- mds_plt$cluster
```
