...
## Tissues
```{r, fig.height=5, fig.width=5}
plot_wordcloud(sheet, col_use = "tissue", scale = c(6, 0.1))
```
...
```{r, fig.height=5, fig.width=5}
plot_wordcloud(sheet, species_use = "Homo sapiens", col_use = "tissue", scale = c(6, 0.1))
```

## Department names

```{r, fig.height=5, fig.width=5}
plot_wordcloud(sheet, col_use = "department", other_stop_words = inst_words, scale = c(6, 0.1))
```
