...
langs %>% 
  ...
  pubs_per_cat(category = "language", isotype = TRUE, img_unit = 1)
```
...
Is this significant? Probably not. Here I fit a linear model to use year to predict proportion of publications with repo or accession and test if the coefficients are 0.
```{r}
