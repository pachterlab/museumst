...
Nobrainer (pun intended). Of course it's brain from ABA, since I left the tissue colum empty for whole Drosophila embryos.
...
### Summaries
```{r}
plot_wordcloud(sheet, summary, year_min = 2001, year_max = 2010)
```
